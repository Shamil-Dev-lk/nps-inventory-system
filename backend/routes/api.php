...
Route::prefix('v1')->group(function () {
    ...
    Route::get('organization', [OrganizationController::class, 'publicInfo']);
    ...
    Route::middleware(['auth:sanctum', 'active.user'])->group(function () {
        ...
        Route::prefix('stock')->group(function () {
            ...
            Route::prefix('issues')->group(function () {
                ...
                Route::post('/{stockIssue}/approve', [StockIssueController::class, 'approve']);
                Route::post('/{stockIssue}/reject',  [StockIssueController::class, 'reject']);
            });
            // Returns
        ...
        Route::prefix('organization')->group(function () {
            ...
            Route::post('logo/{type}',   [OrganizationController::class, 'uploadLogo']);
        });
