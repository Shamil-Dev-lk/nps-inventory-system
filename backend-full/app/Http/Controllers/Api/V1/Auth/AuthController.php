...
class AuthController extends Controller
{
    public function login(Request $request): JsonResponse
    {
        ...
        AuditLog::record('user_login', "User logged in: {$user->email}", $user);
    ...
    {
        AuditLog::record('user_logout', "User logged out: {$request->user()->email}", $request->user());
    ...
    public function changePassword(Request $request): JsonResponse
    {
        ...
        AuditLog::record('password_changed', "Password changed for: {$request->user()->email}", $request->user());
