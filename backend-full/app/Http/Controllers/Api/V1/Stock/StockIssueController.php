...
class StockIssueController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $issues = StockIssue::with(['department', 'warehouse', 'issuedBy', 'officer', 'project', 'customer'])
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            'issue_to_type'   => 'required|in:department,officer,project,customer',
    ...
    public function show(StockIssue $stockIssue): JsonResponse
    {
        ...
        return response()->json(['data' => $stockIssue->load([
            'department', 'warehouse', 'items.item', 'issuedBy', 'approvedBy', 'officer', 'project', 'customer'
        ])]);
    }
