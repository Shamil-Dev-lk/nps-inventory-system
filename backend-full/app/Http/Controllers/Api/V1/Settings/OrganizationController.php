...
class OrganizationController extends Controller
{
    ...
    public function update(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'footer_color' => 'sometimes|nullable|string|max:7',
            'footer_size' => 'sometimes|nullable|string|max:20',
            'footer_font' => 'sometimes|nullable|string|max:50',
            ...
            'print_settings' => 'sometimes|nullable|array',
            'openai_api_key' => 'sometimes|nullable|string',
        ]);

        $settings = OrganizationSetting::first();
        if (!$settings) {
            OrganizationSetting::getInstance(); // ensure creation
            $settings = OrganizationSetting::first();
        }
