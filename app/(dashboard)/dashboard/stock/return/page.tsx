                  ...
                  <tr key={ret.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-5 py-3 text-center">
                      <div className="flex items-center justify-center gap-1">
                        ...
                        <Link href={`/dashboard/stock/return/view/?id=${ret.id}`} className="inline-flex p-1.5 text-muted-foreground hover:text-primary hover:bg-primary/10 rounded-md transition-colors" title="View Details">
                          <Eye size={18} />
                        </Link>
                      </div>
                    </td>
