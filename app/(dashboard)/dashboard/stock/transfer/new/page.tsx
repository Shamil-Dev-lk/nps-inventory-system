...
export default function NewStockTransferPage() {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: (transfer: any) => {
      queryClient.invalidateQueries({ queryKey: ['stock-transfers'] });
      toast.success('Stock transfer created successfully');
      useNotificationStore.getState().addNotification({
        title: 'New Stock Transfer Created',
        description: `Stock Transfer #${transfer.transfer_number || transfer.id} created.`,
        type: 'info',
        link: `/dashboard/stock/transfer/view/?id=${transfer.id}`,
        module: 'Stock Transfer',
      });
      router.push(`/dashboard/stock/transfer/view/?id=${transfer.id}&print=true`);
    },
    onError: (err: any) => {
