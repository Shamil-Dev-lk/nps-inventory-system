                  ...
                  <tr key={t.id} className="hover:bg-muted/30 transition-colors">
                    ...
                    <td className="px-5 py-3 text-center">
                      <div className="flex items-center justify-center gap-1">
                        <button onClick={() => window.open(`/dashboard/receipts/print?type=stock-transfer&id=${t.id}&action=download`, '_blank')} className="p-1.5 rounded text-indigo-400 hover:text-indigo-600 hover:bg-indigo-50 transition-colors" title="Download PDF"><FileDown size={18} /></button>
                        <button onClick={() => window.open(`/dashboard/receipts/print?type=stock-transfer&id=${t.id}`, '_blank')} className="p-1.5 rounded text-emerald-400 hover:text-emerald-600 hover:bg-emerald-50 transition-colors" title="Print Document"><Printer size={18} /></button>
